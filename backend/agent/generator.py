    ...
    if intent == "rag":
        ...
        if tool == "price_estimator":
            ...
            if not service:
                ...
                return {"text": "What service are you interested in? (e.g. weekly mowing, biweekly mowing, spring cleanup, fall leaf removal)", "card": None}
            ...
            # TODO: Google Calendar MCP
            return {"text": "Online booking is coming soon. Our team can help you book directly — would you like us to reach out?", "card": None}
